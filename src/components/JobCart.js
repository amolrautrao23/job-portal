...
const JobCart = ({ elem, isEditable }) => {
    ...
    return (
        <>
            <NavLink to={`/job-detail/${elem._id}`} style={{ "textDecoration": "none",}}>
                <div className="job-cart">
                    ...
                    <p><strong>Summury :</strong> {elem.description}</p>
                    {
                        isEditable && <div className="modify-icons">
                            <NavLink to={`/edit-job/${elem._id}`} className="icon" data-bs-toggle="modal" data-bs-target="#editJob" ><BiSolidEdit /></NavLink>
            ...
            {/* modal */}
            <div className="modal fade" id="editJob" tabIndex="-1" aria-labelledby="editJobLabel" aria-hidden="true">
